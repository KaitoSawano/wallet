...
android {
    namespace = "fr.acinq.zeeygo.android"
    compileSdk = 36
    defaultConfig {
        applicationId = "fr.acinq.zeeygo.mainnet"
        minSdk = 26
        targetSdk = 36
        versionCode = 118
    ...
    buildTypes {
        ...
        applicationVariants.all {
            outputs.forEach {
                val apkName = "zeeygo-${defaultConfig.versionCode}-${defaultConfig.versionName}-${chain.drop(1).dropLast(1)}-${buildType.name}.apk"
...
dependencies {
    implementation(project(":zeeygo-shared"))
