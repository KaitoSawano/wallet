...
import fr.acinq.zeeygo.android.payments.details.PaymentDetailsView
import fr.acinq.zeeygo.android.payments.receive.ReceiveView
import fr.acinq.zeeygo.android.payments.send.SendView
...
fun NavGraphBuilder.paymentsNavGraph(navController: NavController, appViewModel: AppViewModel) {
    ...
    businessComposable(
        ...
        deepLinks = listOf(navDeepLink { uriPattern = "zeeygo:payments/{walletid}/{id}" })
    ...
    businessComposable(
        ...
        deepLinks = listOf(
            ...
            navDeepLink { uriPattern = "zeeygo:lightning:{data}" },
            navDeepLink { uriPattern = "zeeygo:bitcoin:{data}" },
