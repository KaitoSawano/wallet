...
import fr.acinq.zeeygo.android.ZeeyGoApplication
...
class ExperimentalViewModel(val peerManager: PeerManager, private val internalPrefs: InternalPrefs) : ViewModel() {
    ...
    class Factory(
        ...
        override fun <T : ViewModel> create(modelClass: Class<T>, extras: CreationExtras): T {
            val application = checkNotNull(extras[ViewModelProvider.AndroidViewModelFactory.APPLICATION_KEY] as? ZeeyGoApplication)
    ...
    when (state) {
        ...
        is ClaimAddressState.None -> {
            Setting(
                ...
                leadingIcon = { ZeeyGoIcon(R.drawable.ic_arobase) },
                subtitle = {
