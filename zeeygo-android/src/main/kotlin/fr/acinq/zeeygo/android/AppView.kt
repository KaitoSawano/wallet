...
import fr.acinq.zeeygo.android.navigation.baseNavGraph
import fr.acinq.zeeygo.android.navigation.channelsNavGraph
import fr.acinq.zeeygo.android.navigation.homeNavGraph
import fr.acinq.zeeygo.android.navigation.navigateToPaymentDetails
import fr.acinq.zeeygo.android.navigation.paymentsNavGraph
import fr.acinq.zeeygo.android.navigation.settingsNavGraph
import fr.acinq.zeeygo.android.navigation.walletInfoNavGraph
import fr.acinq.zeeygo.android.utils.ZeeyGoAndroidTheme
import fr.acinq.zeeygo.android.utils.appBackground
import fr.acinq.zeeygo.android.utils.datastore.getBitcoinUnits
import fr.acinq.zeeygo.android.utils.datastore.getFiatCurrencies
import fr.acinq.zeeygo.android.utils.datastore.getIsAmountInFiat
import fr.acinq.zeeygo.android.utils.logger
...
private fun UpgradeRequiredBlockingDialog() {
    ...
    Dialog(
        ...
        Button(
            ...
            onClick = { openLink(context = context, link = "https://play.google.com/store/apps/details?id=fr.acinq.zeeygo.mainnet") },
