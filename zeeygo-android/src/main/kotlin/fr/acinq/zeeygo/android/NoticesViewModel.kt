...
import fr.acinq.zeeygo.data.WalletNotice
import fr.acinq.zeeygo.managers.AppConfigurationManager
import fr.acinq.zeeygo.managers.ConnectionsManager
...
class NoticesViewModel(
    ...
    private suspend fun monitorWalletContext() {
        application.zeeygoGlobal.walletContextManager.walletContext.collect {
    ...
    private suspend fun monitorWalletNotice() {
        combine(application.zeeygoGlobal.walletContextManager.walletNotice, internalPrefs.getLastReadWalletNoticeIndex) { notice, lastReadIndex ->
