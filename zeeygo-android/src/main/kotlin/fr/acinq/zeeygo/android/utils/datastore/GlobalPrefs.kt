...
package fr.acinq.zeeygo.android.utils.datastore
...
import fr.acinq.zeeygo.android.BaseWalletId
import fr.acinq.zeeygo.android.EmptyWalletId
...
class GlobalPrefs(private val data: DataStore<Preferences>) {
     ...
     *
     * Specifically, the ZeeyGo SeedManager may be managing more or less seeds than this list contain ; if so the SeedManager is
    ...
    /** Returns the build code of the last ZeeyGo instance that has been run on the device. Used for migration purposes. */
