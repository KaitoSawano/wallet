...
import fr.acinq.zeeygo.android.components.auth.pincode.PinDialogTitle
import fr.acinq.zeeygo.android.components.auth.screenlock.CheckScreenLockPinFlow
import fr.acinq.zeeygo.android.components.auth.screenlock.NewScreenLockPinFlow
import fr.acinq.zeeygo.android.components.auth.spendinglock.CheckSpendingPinFlow
import fr.acinq.zeeygo.android.components.auth.spendinglock.NewSpendingPinFlow
...
import fr.acinq.zeeygo.android.components.prefs.ListPreferenceButton
import fr.acinq.zeeygo.android.components.prefs.PreferenceItem
...
import fr.acinq.zeeygo.android.utils.*
...
private fun CannotUseBiometrics(
    ...
    Setting(
        ...
        leadingIcon = { ZeeyGoIcon(resourceId = R.drawable.ic_fingerprint, tint = MaterialTheme.colors.onSurface) },
...
private fun AutoScreenLockDelayPicker(
    ...
    ListPreferenceButton(
        ...
        leadingIcon = { ZeeyGoIcon(resourceId = R.drawable.ic_lock) },
