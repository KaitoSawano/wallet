...
package fr.acinq.zeeygo.android.components.prefs
...
import fr.acinq.zeeygo.android.utils.extensions.getLabel
import fr.acinq.zeeygo.android.utils.mutedTextFieldColors
...
fun CurrenciesPickerDialog(
    ...
    ModalBottomSheet(
        ...
        TextInput(
            ...
            staticLabel = null,
            leadingIcon = { ZeeyGoIcon(resourceId = R.drawable.ic_inspect, tint = MaterialTheme.typography.caption.color) },
