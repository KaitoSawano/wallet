...
package fr.acinq.zeeygo.android.components.scanner
...
import fr.acinq.zeeygo.android.utils.images.ZxingQrCodeAnalyzer
...
private fun BoxScope.CameraPermissionsView() {
    ...
    if (!cameraPermissionState.status.isGranted) {
        Card(
            ...
            // if user has denied permission, open the system settings for ZeeyGo
