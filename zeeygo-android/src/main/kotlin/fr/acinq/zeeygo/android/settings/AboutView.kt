...
import fr.acinq.zeeygo.android.components.settings.SettingButton
    ...
    DefaultScreenLayout {
        ...
        Card {
            ...
            SettingButton(
                ...
                onClick = { openLink(context, "https://zeeygo.acinq.co/support") }
            )
        }
        Card {
            SettingButton(
                ...
                onClick = { openLink(context, "https://zeeygo.acinq.co/privacy") }
            )
            SettingButton(
                text = stringResource(R.string.about_terms_link),
                icon = R.drawable.ic_text,
                onClick = { openLink(context, "https://zeeygo.acinq.co/terms") }
            )
        }
    }
}
