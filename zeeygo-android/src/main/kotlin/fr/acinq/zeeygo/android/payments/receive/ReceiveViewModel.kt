...
import fr.acinq.zeeygo.managers.zeeygoSwapInWallet
    ...
    private fun monitorCurrentSwapAddress() {
        viewModelScope.launch {
            ...
            if (swapAddressFormat == SwapAddressFormat.LEGACY) {
                val legacySwapInAddress = peerManager.getPeer().zeeygoSwapInWallet.legacySwapInAddress
                ...
                peerManager.getPeer().zeeygoSwapInWallet.swapInAddressFlow.filterNotNull().collect { (newAddress, newIndex) ->
