...
import fr.acinq.zeeygo.android.services.HceService
import fr.acinq.zeeygo.android.services.PaymentsForegroundService
import fr.acinq.zeeygo.android.utils.nfc.NfcReaderCallback
...
class MainActivity : AppCompatActivity() {
     ...
     *
     * For example, instead of `zeeygo:<invoice>`, use `lightning:<invoice>`.
     *
    ...
    private fun Intent.fixUri() {
        ...
        if (scheme == "zeeygo" && ssp != null && (ssp.startsWith("lnbc") || ssp.startsWith("lntb") || ssp.startsWith("lnurl") || ssp.startsWith("lno"))) {
