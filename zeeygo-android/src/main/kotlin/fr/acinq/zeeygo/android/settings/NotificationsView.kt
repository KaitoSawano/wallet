...
import fr.acinq.zeeygo.android.*
...
import fr.acinq.zeeygo.android.home.TorDisconnectedDialog
import fr.acinq.zeeygo.android.navigation.Screen
import fr.acinq.zeeygo.android.services.ChannelsWatcher
...
import fr.acinq.zeeygo.android.utils.converters.DateFormatter.toRelativeDateString
import fr.acinq.zeeygo.android.utils.extensions.safeLet
import fr.acinq.zeeygo.data.Notification
import fr.acinq.zeeygo.data.WatchTowerOutcome
    ...
    when (notice) {
        ...
        Notice.CriticalUpdateAvailable -> {
            ImportantNotification(
                ...
                onActionClick = { openLink(context, "https://play.google.com/store/apps/details?id=fr.acinq.zeeygo.mainnet") }
            )
        }
        ...
        Notice.MempoolFull -> {
            ImportantNotification(
                ...
                onActionClick = { openLink(context, "https://zeeygo.acinq.co/faq#is-zeeygo-affected-by-high-on-chain-fees") },
            )
        }
...
private fun ImportantNotification(
    ...
    Card(
        ...
        Row(modifier = Modifier.padding(top = 12.dp, start = 16.dp, end = 16.dp)) {
            ZeeyGoIcon(resourceId = icon, tint = MaterialTheme.colors.primary, modifier = Modifier.size(18.dp))
            ...
            Column(modifier = Modifier.alignByBaseline()) {
                ...
                safeLet(actionText, onActionClick) { text, onClick ->
                    fr.acinq.zeeygo.android.components.buttons.Button(
