...
import fr.acinq.zeeygo.android.Notice
import fr.acinq.zeeygo.android.R
import fr.acinq.zeeygo.android.UserWallet
...
import fr.acinq.zeeygo.android.components.buttons.MenuButton
...
import fr.acinq.zeeygo.android.components.inputs.CurrencyConverter
...
import fr.acinq.zeeygo.android.components.wallet.ClickableWalletView
import fr.acinq.zeeygo.android.components.wallet.WalletsSelector
import fr.acinq.zeeygo.android.globalPrefs
...
import fr.acinq.zeeygo.data.Notification
...
fun SettingsView(
    ...
    DefaultScreenLayout {
        ...
        Card {
            ...
            val walletContext by application.zeeygoGlobal.walletContextManager.walletContext.collectAsState()
