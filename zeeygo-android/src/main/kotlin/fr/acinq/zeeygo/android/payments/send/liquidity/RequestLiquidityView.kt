...
package fr.acinq.zeeygo.android.payments.send.liquidity
...
import fr.acinq.zeeygo.android.application
import fr.acinq.zeeygo.android.components.AmountView
import fr.acinq.zeeygo.android.components.AmountWithFiatBelow
import fr.acinq.zeeygo.android.components.buttons.BackButtonWithActiveWallet
import fr.acinq.zeeygo.android.components.buttons.BorderButton
import fr.acinq.zeeygo.android.components.buttons.Checkbox
import fr.acinq.zeeygo.android.components.HSeparator
import fr.acinq.zeeygo.android.components.dialogs.IconPopup
import fr.acinq.zeeygo.android.components.ProgressView
import fr.acinq.zeeygo.android.components.inputs.SatoshiDiscretePicker
import fr.acinq.zeeygo.android.components.layouts.SplashLabelRow
import fr.acinq.zeeygo.android.components.layouts.SplashLayout
import fr.acinq.zeeygo.android.components.buttons.TransparentFilledButton
import fr.acinq.zeeygo.android.components.buttons.SmartSpendButton
import fr.acinq.zeeygo.android.components.dialogs.ModalBottomSheet
import fr.acinq.zeeygo.android.components.enableOrFade
import fr.acinq.zeeygo.android.components.feedback.ErrorMessage
import fr.acinq.zeeygo.android.components.feedback.InfoMessage
import fr.acinq.zeeygo.android.components.feedback.SuccessMessage
import fr.acinq.zeeygo.android.payments.send.spliceout.spliceFailureDetails
import fr.acinq.zeeygo.android.utils.converters.AmountFormatter.toPrettyString
import fr.acinq.zeeygo.android.utils.annotatedStringResource
import fr.acinq.zeeygo.android.utils.mutedBgColor
import fr.acinq.zeeygo.android.utils.orange
    ...
    Column(
        ...
        Row {
            ...
            IconPopup(
                ...
                popupLink = stringResource(id = R.string.liquidityads_faq_link) to "https://zeeygo.acinq.co/faq#what-is-inbound-liquidity",
...
private fun LeaseEstimationView(
    ...
    SplashLabelRow(
        ...
        helpLink = stringResource(id = R.string.liquidityads_faq_link) to "https://zeeygo.acinq.co/faq#what-happens-after-a-year-of-reserving-liquidity",
    ) {
        Column {
            Text(
