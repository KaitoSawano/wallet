...
import fr.acinq.zeeygo.android.utils.UserTheme
...
import fr.acinq.zeeygo.android.utils.extensions.label
...
@Composable
private fun FiatCurrencyPreference(business: ZeeyGoBusiness, walletId: WalletId, userPrefs: UserPrefs, scope: CoroutineScope) {
    ...
    val currencyManager = business.zeeygoGlobal.currencyManager
