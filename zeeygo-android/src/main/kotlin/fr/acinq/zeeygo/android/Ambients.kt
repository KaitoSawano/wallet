...
import fr.acinq.zeeygo.android.utils.datastore.GlobalPrefs
...
import fr.acinq.zeeygo.controllers.ControllerFactory
import fr.acinq.zeeygo.data.*
import fr.acinq.zeeygo.managers.AppConfigurationManager
...
val LocalBusiness = compositionLocalOf<ZeeyGoBusiness?> { null }
...
val application: ZeeyGoApplication
    @Composable
    get() = LocalContext.current.applicationContext as? ZeeyGoApplication ?: error("Application is not of type ZeeyGoApplication. Are you using appView in preview?")
