...
import fr.acinq.zeeygo.ZeeyGoGlobal
...
class ZeeyGoApplication : Application() {

    private val log = LoggerFactory.getLogger(this::class.java)

    lateinit var globalPrefs: GlobalPrefs
    lateinit var zeeygoGlobal: ZeeyGoGlobal

    override fun onCreate() {
        super.onCreate()
        Logging.setupLogger(applicationContext)

        zeeygoGlobal = ZeeyGoGlobal(PlatformContext(applicationContext))
