...
package fr.acinq.zeeygo.android.settings
...
import fr.acinq.zeeygo.android.CF
...
import fr.acinq.zeeygo.android.components.layouts.Card
...
import fr.acinq.zeeygo.android.components.inputs.FeerateSlider
import fr.acinq.zeeygo.android.components.ProgressView
import fr.acinq.zeeygo.android.components.inputs.TextInput
...
import fr.acinq.zeeygo.android.components.mvi.MVIView
...
import fr.acinq.zeeygo.android.utils.extensions.safeLet
import fr.acinq.zeeygo.android.utils.monoTypo
import fr.acinq.zeeygo.controllers.config.CloseChannelsConfiguration
import fr.acinq.zeeygo.data.BitcoinUriError
import fr.acinq.zeeygo.utils.Parser
...
fun MutualCloseView(
    ...
    val mempoolFeerate by application.zeeygoGlobal.feerateManager.mempoolFeerate.collectAsState()
