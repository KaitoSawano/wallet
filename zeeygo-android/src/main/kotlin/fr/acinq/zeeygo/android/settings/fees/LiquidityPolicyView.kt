...
package fr.acinq.zeeygo.android.settings.fees
...
import fr.acinq.zeeygo.android.components.inputs.InlineSatoshiInput
...
import fr.acinq.zeeygo.android.components.settings.SettingSwitch
    ...
    Column(modifier = Modifier.padding(horizontal = 16.dp, vertical = 12.dp)) {
        ...
        when (mempoolFeerate) {
            null -> ProgressView(text = stringResource(id = R.string.liquiditypolicy_fees_estimation_loading), progressCircleSize = 16.dp, padding = PaddingValues(0.dp))
                ...
                Row {
                    ZeeyGoIcon(resourceId = R.drawable.ic_info, modifier = Modifier.offset(y = 2.dp))
