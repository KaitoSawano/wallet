...
import fr.acinq.zeeygo.android.settings.walletinfo.FinalWalletInfo
import fr.acinq.zeeygo.android.settings.walletinfo.FinalWalletRefundView
import fr.acinq.zeeygo.android.settings.walletinfo.SendSwapInRefundView
import fr.acinq.zeeygo.android.settings.walletinfo.SwapInAddresses
import fr.acinq.zeeygo.android.settings.walletinfo.SwapInSignerView
import fr.acinq.zeeygo.android.settings.walletinfo.SwapInWallet
import fr.acinq.zeeygo.android.settings.walletinfo.WalletInfoView
...
fun NavGraphBuilder.walletInfoNavGraph(navController: NavController, appViewModel: AppViewModel) {
    ...
    businessComposable(
        ...
        deepLinks = listOf(
            navDeepLink { uriPattern = "zeeygo:swapinwallet/{walletId}" }
        )
