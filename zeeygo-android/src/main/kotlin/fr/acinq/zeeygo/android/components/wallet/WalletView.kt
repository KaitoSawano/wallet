...
package fr.acinq.zeeygo.android.components.wallet
...
import fr.acinq.zeeygo.android.components.dialogs.PopupBasicDialog
    ...
    if (business != null) {
        PopupBasicDialog(
            ...
            if (showBalance) {
                ...
                Row {
                    ZeeyGoIcon(resourceId = R.drawable.ic_send)
            ...
            if (showInbound) {
                ...
                Spacer(Modifier.height(4.dp))
                Row {
                    ZeeyGoIcon(resourceId = R.drawable.ic_bucket)
                    Spacer(Modifier.width(4.dp))
