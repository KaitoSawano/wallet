...
import fr.acinq.zeeygo.android.security.EncryptedSeed
...
class ResetWalletViewModel(val application: ZeeyGoApplication, val walletId: WalletId) : ViewModel() {
    ...
    fun deleteWalletData(
        ...
        viewModelScope.launch(Dispatchers.IO + CoroutineExceptionHandler { _, e ->
            ...
            context.deleteDatabase("payments-${chain.zeeygoName}-${walletId.nodeIdHash}.sqlite")
            context.deleteDatabase("channels-${chain.zeeygoName}-${walletId.nodeIdHash}.sqlite")
            delay(500)
    ...
    class Factory(val application: ZeeyGoApplication, val walletId: WalletId) : ViewModelProvider.Factory {
