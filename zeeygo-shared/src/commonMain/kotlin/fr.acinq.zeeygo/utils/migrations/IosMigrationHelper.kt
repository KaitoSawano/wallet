...
package fr.acinq.zeeygo.utils.migrations
...
import fr.acinq.zeeygo.utils.extensions.isBeingCreated
...
object IosMigrationHelper {
    ...
    suspend fun doMigrateChannels(
        ...
        try {
            ...
            val swapInAddress = peer.zeeygoSwapInWallet.swapInAddressFlow.filterNotNull().first().first
            ...
            val mempoolFeerate = biz.zeeygoGlobal.feerateManager.mempoolFeerate.filterNotNull().first()
            ...
            peer.zeeygoSwapInWallet.wallet.walletStateFlow
