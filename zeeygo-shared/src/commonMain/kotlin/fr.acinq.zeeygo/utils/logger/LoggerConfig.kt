...
package fr.acinq.zeeygo.utils.logger
 ...
 */
data class ZeeyGoLoggerConfig(private val platformContext: PlatformContext): LoggerConfig {
    override val logWriterList: List<LogWriter> = zeeygoLogWriters(platformContext)
 ...
 */
expect fun zeeygoLogWriters(ctx: PlatformContext): List<LogWriter>