...
package fr.acinq.zeeygo.utils.swapin
...
object SwapInSignerHelper {
    ...
    suspend fun signPartialTxLegacy(business: ZeeyGoBusiness, unsignedTx: String): LegacySwapInSignerResult {
    ...
    suspend fun signPartialTxTaproot(business: ZeeyGoBusiness, unsignedTx: String, serverNonce: String): TaprootSwapInSignerResult {
        val loggerFactory = business.loggerFactory
        val log = loggerFactory.newLogger(this::class)
