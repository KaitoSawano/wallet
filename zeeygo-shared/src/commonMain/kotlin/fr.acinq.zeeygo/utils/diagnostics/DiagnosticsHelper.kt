...
package fr.acinq.zeeygo.utils.diagnostics
...
import fr.acinq.zeeygo.managers.zeeygoFinalWallet
import fr.acinq.zeeygo.managers.zeeygoSwapInWallet
import fr.acinq.zeeygo.shared.BuildVersions
...
object DiagnosticsHelper {
    ...
    suspend fun getDiagnostics(business: ZeeyGoBusiness): String {
        ...
        result.appendLine("commit: ${BuildVersions.ZEEYGO_COMMIT}")
        ...
        result.appendLine("mempoolspace feerate: ${business.zeeygoGlobal.feerateManager.mempoolFeerate.first()}")
        ...
        val swapInWalletState = peerManager.getPeer().zeeygoSwapInWallet.wallet.walletStateFlow.filterNotNull().first()
        ...
        result.appendLine("]")
        result.appendLine("final wallet address: ${peerManager.getPeer().zeeygoFinalWallet.finalAddress}")
