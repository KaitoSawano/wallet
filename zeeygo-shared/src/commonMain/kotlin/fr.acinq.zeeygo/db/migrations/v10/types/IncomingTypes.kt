...
package fr.acinq.zeeygo.db.migrations.v10.types
...
import fr.acinq.zeeygo.db.migrations.v11.types.liquidityads.FundingFeeData
import fr.acinq.zeeygo.db.migrations.v10.json.ByteVector32Serializer
import fr.acinq.zeeygo.db.migrations.v10.json.ByteVectorSerializer
import fr.acinq.zeeygo.db.migrations.v10.json.MilliSatoshiSerializer
import fr.acinq.zeeygo.db.migrations.v10.json.OutpointSerializer
import fr.acinq.zeeygo.db.migrations.v10.json.SatoshiSerializer
import fr.acinq.zeeygo.db.migrations.v10.json.UUIDSerializer
import fr.acinq.zeeygo.db.migrations.v11.types.liquidityads.FundingFeeData.Companion.asCanonical
import fr.acinq.zeeygo.utils.extensions.deriveUUID
...
private sealed class IncomingReceivedWithData {
    ...
    sealed class NewChannel : IncomingReceivedWithData() {
        @Serializable
        @SerialName("fr.acinq.zeeygo.db.payments.IncomingReceivedWithData.NewChannel.V0")
    ...
    sealed class Part : IncomingReceivedWithData() {
        ...
        sealed class Htlc : Part() {
            ...
            @Serializable
            @SerialName("fr.acinq.zeeygo.db.payments.IncomingReceivedWithData.Part.Htlc.V0")
            data class V0(
            ...
            @Serializable
            @SerialName("fr.acinq.zeeygo.db.payments.IncomingReceivedWithData.Part.Htlc.V1")
            data class V1(
        ...
        sealed class NewChannel : Part() {
            ...
            @Serializable
            @SerialName("fr.acinq.zeeygo.db.payments.IncomingReceivedWithData.Part.NewChannel.V0")
            data class V0(
                val amount: MilliSatoshi,
            ...
            @Serializable
            @SerialName("fr.acinq.zeeygo.db.payments.IncomingReceivedWithData.Part.NewChannel.V1")
            data class V1(
                val id: UUID,
                val amount: MilliSatoshi,
                val fees: MilliSatoshi,
            ...
            @Serializable
            @SerialName("fr.acinq.zeeygo.db.payments.IncomingReceivedWithData.Part.NewChannel.V2")
            data class V2(
                val amount: MilliSatoshi,
        ...
        sealed class SpliceIn : Part() {
            @Serializable
            @SerialName("fr.acinq.zeeygo.db.payments.IncomingReceivedWithData.Part.SpliceIn.V0")
            data class V0(
                val amount: MilliSatoshi,
                val serviceFee: MilliSatoshi,
                val miningFee: Satoshi,
        ...
        sealed class FeeCredit : Part() {
            @Serializable
            @SerialName("fr.acinq.zeeygo.db.payments.IncomingReceivedWithData.Part.FeeCredit.V0")
            data class V0(
                val amount: MilliSatoshi
            ) : FeeCredit()
        }
