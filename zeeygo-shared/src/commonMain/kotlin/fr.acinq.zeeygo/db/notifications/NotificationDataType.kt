...
package fr.acinq.zeeygo.db.notifications
...
internal sealed class NotificationData {
    ...
    companion object {
        ...
        private fun Notification.asDb(): NotificationData = when (this) {
            ...
            is fr.acinq.zeeygo.data.WatchTowerOutcome.Nominal -> WatchTowerOutcome.Nominal.V0(channelsWatchedCount)
            is fr.acinq.zeeygo.data.WatchTowerOutcome.RevokedFound -> WatchTowerOutcome.RevokedFound.V0(channels)
            is fr.acinq.zeeygo.data.WatchTowerOutcome.Unknown -> WatchTowerOutcome.Unknown.V0
        }
    }
}
