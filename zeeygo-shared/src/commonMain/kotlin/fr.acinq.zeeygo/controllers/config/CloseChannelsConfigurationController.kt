...
import fr.acinq.zeeygo.controllers.config.CloseChannelsConfiguration.Model.ChannelInfoStatus
import fr.acinq.zeeygo.utils.Parser
import fr.acinq.zeeygo.utils.extensions.localBalance
...
class AppCloseChannelsConfigurationController(
    ...
    constructor(business: ZeeyGoBusiness, isForceClose: Boolean): this(
        ...
        launch {
            ...
            peer.channelsFlow.collect { channels ->
                ...
                if (closingChannelIdsCopy != null) {
                    ...
                    val address = peer.zeeygoFinalWallet.finalAddress
