...
import fr.acinq.zeeygo.controllers.*
import fr.acinq.zeeygo.controllers.config.*
import fr.acinq.zeeygo.controllers.init.AppInitController
import fr.acinq.zeeygo.controllers.init.AppRestoreWalletController
import fr.acinq.zeeygo.controllers.main.AppContentController
import fr.acinq.zeeygo.controllers.main.AppHomeController
import fr.acinq.zeeygo.controllers.payments.AppReceiveController
import fr.acinq.zeeygo.data.StartupParams
import fr.acinq.zeeygo.managers.*
import fr.acinq.zeeygo.utils.*
...
class ZeeyGoBusiness(
    val zeeygoGlobal: ZeeyGoGlobal,
) {
    val loggerFactory = zeeygoGlobal.loggerFactory
