...
import fr.acinq.zeeygo.utils.extensions.*
 ...
 *      while ZeeyGo was disconnected). If false, this data is the live view of the channel as negotiated with the
...
data class LocalChannelInfo(
    ...
    companion object { /* allow companion extensions; see ZeeyGoExposure.kt */ }
}
