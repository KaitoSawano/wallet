...
import fr.acinq.zeeygo.utils.runTest
...
import fr.acinq.zeeygo.utils.testLoggerFactory
...
class SqlitePaymentsDbTest : UsingContextTest() {
    ...
    fun `read v1 db`() = runTest {
        val driver = createPaymentsDbDriver(getPlatformContext(), fileName = "payments-mainnet-fedc36138a62ceadc8a93861d2c46f5ca5e8b418.sqlite", onError = onError)
    ...
    fun `read v1 db - additional`() = runTest {
        val driver = createPaymentsDbDriver(getPlatformContext(), fileName = "payments-mainnet-a224978853d2f4c94ac8e2dbb2acf8344e0146d0.sqlite", onError = onError)
        val paymentsDb = createSqlitePaymentsDb(driver, metadataQueue = null, loggerFactory = testLoggerFactory)
    ...
    fun `read v6 db`() = runTest {
        val driver = createPaymentsDbDriver(getPlatformContext(), fileName = "payments-mainnet-700486fc7a90d5922d6f993f2941ab9f9f1a9d85.sqlite", onError = onError)
        val paymentsDb = createSqlitePaymentsDb(driver, metadataQueue = null, loggerFactory = testLoggerFactory)
    ...
    fun `read v10 db - large dataset`() = runTest {
        val driver = createPaymentsDbDriver(getPlatformContext(), fileName = "payments-mainnet-28903aff.sqlite", onError = onError)
        val paymentsDb = createSqlitePaymentsDb(driver, metadataQueue = null, loggerFactory = testLoggerFactory)
    ...
    fun `read v10 db - fees`() = runTest {
        val driver = createPaymentsDbDriver(getPlatformContext(), fileName = "payments-mainnet-f921bddf.sqlite", onError = onError)
        val paymentsDb = createSqlitePaymentsDb(driver, metadataQueue = null, loggerFactory = testLoggerFactory)
    ...
    fun `read v10 db - liquidity`() = runTest {
        val driver = createPaymentsDbDriver(getPlatformContext(), fileName = "payments-mainnet-6a5e6f.sqlite", onError = onError)
        val paymentsDb = createSqlitePaymentsDb(driver, metadataQueue = null, loggerFactory = testLoggerFactory)
