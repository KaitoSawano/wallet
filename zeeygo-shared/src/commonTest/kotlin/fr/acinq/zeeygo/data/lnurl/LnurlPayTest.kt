...
class LnurlPayTest {
    ...
    fun lud17() {
        ...
        assertIs<Lnurl.Request>(Lnurl.extractLnurl("zeeygo:lnurlp://$validClearLud17", logger))
    ...
    fun invoice_successaction_aes() {
        // same data as zeeygo-android LnurlPayTest AES-decryption test, base64-encoded:
