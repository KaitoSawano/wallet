...
What does this mean for ZeeyGo ?

* Apple does NOT allow the main ZeeyGo app to run in response to a push notification
* Apple does allow us to create a separate mini-process. This is like a mini version of ZeeyGo with no UI. And iOS will launch this process in response to a received push notification (under certain conditions)
...
- when a push notification arrives for ZeeyGo, iOS asks the question "is the mainApp open AND in the foreground"
