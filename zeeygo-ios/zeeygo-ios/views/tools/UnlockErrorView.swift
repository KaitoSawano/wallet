...
fileprivate struct _UnlockErrorView: View {
	...
	var mainContent: some View {
		...
		VStack(alignment: HorizontalAlignment.center, spacing: 0) {
			...
			Text("A temporary error occurred, and ZeeyGo is unable to continue loading.")
				.font(.title2)
				.multilineTextAlignment(.center)
				.padding(.bottom, 60)
			
			Text("Please restart ZeeyGo")
				.padding(.bottom)
			...
			Text("If the problem persists, please contact support at **zeeygo@acinq.co**.")
				.multilineTextAlignment(.center)
				.padding(.bottom)
			...
			Text("ZeeyGo Version: \(versionString())")
