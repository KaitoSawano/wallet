...
//		
//		var body = "ZeeyGo v\(appVersion ?? "x.y.z") "
//		body += "(\(device.systemName) \(device.systemVersion))"
//		
//		var comps = URLComponents()
//		comps.scheme = "mailto"
//		comps.path = "zeeygo@acinq.co"
//		comps.queryItems = [
//			URLQueryItem(name: "subject", value: "ZeeyGo iOS Feedback"),
...
//	}
	...
	func supportButtonTapped() {
		...
		if let url = URL(string: "https://zeeygo.acinq.co/support") {
			openURL(url)
		}
	}
	...
	func faqButtonTapped() {
		...
		if let url = URL(string: "https://zeeygo.acinq.co/faq") {
			openURL(url)
		}
	}
	...
	func githubButtonTapped() {
		...
		if let url = URL(string: "https://github.com/ACINQ/zeeygo") {
			openURL(url)
		}
	}
}
