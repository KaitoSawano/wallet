...
/// Encompasses security operations shared between zeeygo & zeeygo-notifySrvExt
///
class SharedSecurity {
	...
	private lazy var groupDirectoryUrl: URL = {
		...
		guard let groupDir = fm.containerURL(forSecurityApplicationGroupIdentifier: "group.co.acinq.zeeygo") else {
