...
fileprivate let taskId_watchTower = "co.acinq.zeeygo.WatchTower"
...
class WatchTower {
	...
	private func performTask(_ task: BGAppRefreshTask, _ target: WatchTowerTarget) {
		...
		let business = ZeeyGoBusiness(zeeygoGlobal: BusinessManager.zeeygoGlobal)
	...
	private func performTask(_ task: BGAppRefreshTask, _ business: ZeeyGoBusiness, _ id: String) {
		log.trace(#function)
